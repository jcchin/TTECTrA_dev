...
% Accel Limiter
%---------------------------------------
%ttectra_in.SMLimit.Accel=11; %TEMP - Use for debugging accel schedule
%[output]=TTECTrA_NPSS_AccelLimiter(ttectra_in);
%ttectra_in.Limiter=output.Limiter;
% Issues with accel schedule, therefore enter a default one

...
% Simulation parameters
%---------------------------------------
load_system(inputs.in.simFileNamePWLM);

temp_path='NPSS_TTECTrA_PWLM/';
...
%---------------------------------------
temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/';
...
%---------------------------------------
temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/Setpoint Controller/';
...
%---------------------------------------
temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/Tranisent Limiter Logic/';
...
%---------------------------------------
temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/Tranisent Limiter Logic/Decel/';
...
%---------------------------------------
temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/Tranisent Limiter Logic/Accel Sched/';
...
% %---------------------------------------
% temp_path='NPSS_TTECTrA_PWLM/TTECTrA Simulink Block/Thrust Solver Controller/';
% 
